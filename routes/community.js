...
//routes 
const createRoute = require('./community/create')
router.use('/', createRoute);

const getAllRoute = require('./community/getAll');
...
const getMyJoinedCommunityRoute = require('./community/getMyJoinedCommunity');
router.use('/me/member', getMyJoinedCommunityRoute);
